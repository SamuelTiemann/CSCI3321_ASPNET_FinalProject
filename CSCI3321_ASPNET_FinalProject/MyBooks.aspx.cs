...
namespace CSCI3321_ASPNET_FinalProject
{
    public partial class MyBooks : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "SELECT Title, FirstName, LastName, Price, PublishDate, PublisherName, GenreName FROM Books "+" INNER JOIN Publishers ON Books.PublisherID = Publishers.PublisherID "
                +"INNER JOIN Genres ON Books.GenreID = Genres.GenreID "+"INNER JOIN Authors ON Books.AuthorID = Authors.AuthorID";
